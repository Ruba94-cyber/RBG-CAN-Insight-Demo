...
[Watch the 56-second live application demo on YouTube](https://youtu.be/3Kbfls5glMc), [watch the 50-second Short](https://youtube.com/shorts/RsJgOJQLnfQ), or [download the demo kit release](https://github.com/Ruba94-cyber/RBG-CAN-Insight-Demo/releases/tag/demo-v1.0).
